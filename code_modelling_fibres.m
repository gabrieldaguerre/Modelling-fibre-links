...
Pulse_In = P0 * (exp(-(t-t01).^2 / (2*tau0^2)));

Delta_Tau1 = D * Delta_Lambda * l1;
Delta_Tau2 = D * Delta_Lambda * l2;
Delta_Tau3 = D * Delta_Lambda * l3;
...
Pulse_Out1_10km = P0 * A1 * (exp(-(t-t01).^2 / (2*Tau1^2)));
Pulse_Out2_50km = P0 * A2 * (exp(-(t-t01).^2 / (2*Tau2^2)));
Pulse_Out3_100km = P0 * A3 * (exp(-(t-t01).^2 / (2*Tau3^2)));



plot(t,Pulse_In,t,Pulse_Out1_10km,t,Pulse_Out2_50km,t,Pulse_Out3_100km);
%%
subplot(3,1,1)
t = 0e-9 : 0.01e-9 : 5e-9;
t01 = 2.5e-9;
